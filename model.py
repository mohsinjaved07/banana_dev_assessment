...
class TestOnnx:
    def __init__(self):
        ...
        self.ort_outs = None
        self.ort_session = onnxruntime.InferenceSession("./ImageClassifier.onnx")
    ...
    def output_prediction(self, img_y):
        self.ort_inputs = {self.ort_session.get_inputs()[0].name: self.to_numpy(img_y)}
        self.ort_outs = self.ort_session.run(None, self.ort_inputs)
        return self.ort_outs